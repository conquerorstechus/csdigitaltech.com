          ...
          <div className='max-w-7xl mx-auto px-4 '>
            <div className=' grid grid-cols-1 md:grid-cols-2 gap-10 items-center '>
              ...
              <div>
                ...
                <p className='text-gray-500 lg:text-base text-sm font-medium lg:leading-8'>
                  At Cornerstone Digital Technologies, we help clients to achieve their business
                ...
                <p className='text-gray-500 lg:text-base text-sm font-medium lg:leading-8'>
                  ...
                  project team, led by a Cornerstone Digital Technologies Software technologies
            ...
            <div className='mt-16 '>
              <h2 className='text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 '>
                Cornerstone Digital Technologies with best CMS Applications:
              </h2>
              <p className='mt-4 text-gray-500  text-sm sm:text-lg lg:leading-8'>
               Cornerstone Digital Technologies technology provides an excellent CMS application with two popular types Open source applications and proprietary CMS applications.
              </p>
              <p className='mt-4 text-gray-500  text-sm sm:text-lg lg:leading-8'>
