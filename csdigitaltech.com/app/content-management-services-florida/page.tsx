...
export const metadata = getComprehensiveMetadata(
  ...
  "Streamline and scale your content with Cornerstone Digital Technologies’ content management services in Florida — from CMS setup to content governance and publishing.",
...
export default function ContentManagementServices() {
  const structuredData = getStructuredData(
    "Content Management Services in Florida | Cornerstone Digital Technologies Tech",
    "Cornerstone Digital Technologies is a leading content management services company in Florida offering CMS solutions, WordPress, Drupal, Joomla development, and enterprise content management. Get professional CMS consulting and development services.",
    "/content-management-services-florida",
    "Service"
  );
