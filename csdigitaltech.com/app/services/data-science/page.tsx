...
export const metadata = getComprehensiveMetadata(
  ...
  'Leverage Cornerstone Digital Technologies’ AI-driven data analytics to build robust predictive models, real-time dashboards, and actionable BI solutions that drive business value.',
