        ...
        <section className='py-16 px-4 bg-gradient-to-b from-gray-50 to-white'>
          <div className='max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
            ...
            <div>
              ...
              Cornerstone Digital Technologies USA helps businesses across Florida and nearby regions leverage the power of Artificial Intelligence (AI) and Machine Learning (ML) to improve efficiency, reduce costs, and deliver smarter customer experiences.
              </p>
        ...
        <section className='relative py-20 px-4 overflow-hidden bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600'>
          ...
          <div className='relative z-10 max-w-4xl mx-auto text-center'>
            ...
            <p className='text-white/90 text-lg sm:text-xl leading-relaxed mb-10'>
              Cornerstone Digital Technologies helps Florida businesses integrate and implement AI/ML solutions that improve performance, reduce costs, and create new growth opportunities.
            </p>
