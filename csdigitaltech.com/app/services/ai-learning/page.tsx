...
export const metadata = getComprehensiveMetadata(
  ...
  'Transform education with AI-Powered Learning Solutions in Florida by Cornerstone Digital Technologies, offering personalized, smart, and scalable learning experiences for institutions.',
