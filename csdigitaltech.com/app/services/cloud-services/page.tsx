...
export const metadata = getComprehensiveMetadata(
  ...
  "Need reliable cloud support? Cornerstone Digital Technologies in Florida provides cloud services that keep your data safe, your systems scalable, and your costs under control.",
