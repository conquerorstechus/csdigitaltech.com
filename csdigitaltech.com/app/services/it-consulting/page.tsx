...
export const metadata = getComprehensiveMetadata(
  ...
  'Unlock AI-powered IT consulting in Florida with Cornerstone Digital Technologies. Custom solutions from automation to ERP. Boost efficiency today with a free consult!',
