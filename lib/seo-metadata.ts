...
export function getMetadata(
  ...
  return {
    title: `${pageTitle} | Conquerors Technologies`,
    ...
    openGraph: {
      ...
      description: pageDescription,
      url: fullUrl,
      siteName: "Conquerors Technologies",
      images: [
        {
          url: fullImage,
          width: 1200,
    ...
    authors: [{ name: "Conquerors Technologies" }],
    creator: "Conquerors Technologies",
    publisher: "Conquerors Technologies",
    formatDetection: {
      email: false,
      address: false,
      telephone: false,
...
export function getStructuredData(
  ...
  const baseStructuredData = {
    ...
    "@type": pageType,
    "name": `${pageTitle} | Conquerors Technologies`,
    "description": pageDescription,
    "url": fullUrl,
    "publisher": {
      "@type": "Organization",
      "name": "Conquerors Technologies",
      "url": domain,
      "logo": {
        "@type": "ImageObject",
  ...
  if (pageType === "Article") {
    return {
      ...
      "author": {
        "@type": "Person",
        "name": additionalData?.author || "Conquerors Technologies",
        "url": domain
      },
    ...
    "@graph": [
      {
        ...
        "description": "Conquerors Technologies delivers end-to-end AI & ML services in Florida—AI strategy development, data engineering, predictive analytics, custom model building, NLP solutions, automation systems, and enterprise AI implementation.",
        "hasOfferCatalog": {
          "@type": "OfferCatalog",
    ...
    "@graph": [
      {
        ...
        "description": "Conquerors Technologies provides complete custom LLM development services in Florida—enterprise training, domain-specific model creation, LLM fine-tuning, RAG implementation, vector database integration, AI chatbot building, and end-to-end LLM deployment for businesses.",
        "hasOfferCatalog": {
          "@type": "OfferCatalog",
    ...
    "@graph": [
      {
        ...
        "description": "Conquerors Technologies offers professional AI learning services in Florida, including personalized AI learning programs, machine learning courses, hands-on AI workshops, corporate AI training, and AI upskilling solutions for businesses, institutions, and individuals.",
        "hasOfferCatalog": {
          "@type": "OfferCatalog",
    ...
    "@graph": [
      {
        ...
        "description": "Conquerors Technologies delivers cutting-edge AI-powered MMRAG (Multimodal Retrieval-Augmented Generation) services in Florida, enabling enterprises to process and retrieve information from text, images, audio, video, and structured data. Services include custom MMRAG development, multimodal AI pipelines, vector database integration, and AI automation solutions.",
        "hasOfferCatalog": {
          "@type": "OfferCatalog",
    ...
    "@graph": [
      {
        ...
        "description": "Conquerors Technologies delivers end-to-end Data Analytics and BI solutions in Florida, offering predictive analytics, business dashboards, ETL pipelines, data warehousing, KPI reporting, cloud-based BI, and enterprise data modernization services.",
        "hasOfferCatalog": {
          "@type": "OfferCatalog",
    ...
    "@graph": [
      {
        ...
        "description": "Conquerors Technologies helps businesses leverage data science to drive insights and innovation, offering predictive modeling, ML development, statistical analysis, data automation, big data pipelines, and enterprise data science consulting.",
        "areaServed": {
          "@type": "Place",
          "name": "USA"
        },
    ...
    "@graph": [
      {
        ...
        "description": "Conquerors Technologies offers complete digital cloud solutions in Florida including cloud infrastructure setup, cloud strategy consulting, multi-cloud deployment, DevOps automation, cloud-native application development, and 24/7 managed cloud operations.",
        "hasOfferCatalog": {
          "@type": "OfferCatalog",
    ...
    "@graph": [
      {
        ...
        "description": "Conquerors Technologies provides complete cloud services in Florida including cloud consulting, migration, cloud security implementation, multi-cloud deployment, cloud-native development, and 24/7 managed cloud support for businesses seeking scalability and security.",
        "hasOfferCatalog": {
          "@type": "OfferCatalog",
    ...
    "@graph": [
      {
        ...
        "description": "Conquerors Technologies offers comprehensive testing services in Florida, including end-to-end QA solutions, functional testing, test automation, API testing, performance engineering, mobile testing, security audits, and enterprise QA consulting.",
        "hasOfferCatalog": {
          "@type": "OfferCatalog",
    ...
    "@graph": [
      {
        ...
        "description": "Conquerors Technologies delivers complete branding solutions, including brand strategy, logo design, corporate identity development, visual communication, rebranding, digital brand presence, and brand storytelling services tailored for modern businesses.",
        "hasOfferCatalog": {
          "@type": "OfferCatalog",
    ...
    "@graph": [
      {
        ...
        "description": "Conquerors Technologies delivers end-to-end mobile app development services including native Android & iOS apps, hybrid app development, cross-platform apps, UI/UX design, app integration, and scalable enterprise app solutions.",
        "hasOfferCatalog": {
          "@type": "OfferCatalog",
    ...
    "@graph": [
      {
        ...
        "description": "Conquerors Technologies delivers high-performance custom web application development services, specializing in enterprise-grade applications, CMS-based websites, progressive web apps, full-stack development, and secure, scalable web solutions tailored to business requirements.",
        "hasOfferCatalog": {
          "@type": "OfferCatalog",
...
export function getAIMLServicesFloridaFAQSchema() {
  return {
    ...
    "mainEntity": [
      ...
      {
        "@type": "Question",
        "name": "What makes Conquerors different from other AI providers in Florida?",
        "acceptedAnswer": {
          "@type": "Answer",
...
export function getCustomLLMsFloridaFAQSchema() {
  return {
    ...
    "mainEntity": [
      ...
      {
        "@type": "Question",
        "name": "Why should I choose Conquerors Software Technologies USA for LLM integration in Florida?",
        "acceptedAnswer": {
          "@type": "Answer",
...
export function getAIPoweredMMRAGServicesFloridaFAQSchema() {
  return {
    ...
    "mainEntity": [
      ...
      {
        "@type": "Question",
        "name": "Why should I choose Conquerors Software Technologies USA for MMRAG?",
        "acceptedAnswer": {
          "@type": "Answer",
...
export function getDigitalCloudSolutionsFloridaFAQSchema() {
  return {
    ...
    "mainEntity": [
      ...
      {
        "@type": "Question",
        "name": "Why choose Conquerors Software Technologies USA?",
        "acceptedAnswer": {
          "@type": "Answer",
...
export function getTestingServicesFloridaFAQSchema() {
  return {
    ...
    "mainEntity": [
      ...
      {
        "@type": "Question",
        "name": "What are the benefits of outsourcing QA to Conquerors?",
        "acceptedAnswer": {
          "@type": "Answer",
...
export function getWebDevelopmentServicesFAQSchema() {
  return {
    ...
    "mainEntity": [
      ...
      {
        "@type": "Question",
        "name": "Why should I choose Conquerors Software Technologies USA for AI-driven web design in Florida?",
        "acceptedAnswer": {
          "@type": "Answer",
...
export function getHomePageFAQSchema() {
  return {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What services does Conquerors Software Technologies offer?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "How do I get started with Conquerors Software Technologies?",
        "acceptedAnswer": {
          "@type": "Answer",
