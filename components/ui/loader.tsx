  ...
  return (
    <div className='fixed inset-0 bg-white/90 backdrop-blur-sm z-[70] flex items-center justify-center'>
      <div className='relative w-24 h-24'>
        ...
        {/* Middle ring */}
        <div
          className='absolute inset-3 border-4 border-transparent rounded-full animate-spin'
          style={{
        ...
        {/* Inner ring */}
        <div
          className='absolute inset-6 border-4 border-transparent rounded-full animate-spin-fast'
          style={{
