      ...
      <div className="max-w-3xl mx-auto px-4 pb-20">
        <div className="prose prose-sm max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-gray-700 mb-3">Permission is granted to temporarily download one copy of the materials (information or software) on our website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title.</p>
          ...
          <section>
            ...
            <p className="text-gray-700 mb-3">Our services are provided on a subscription basis:</p>
            <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
              <li>Services renew automatically unless cancelled</li>
              <li>You can cancel anytime with no penalties</li>
              <li>Refunds are provided within 30 days of cancellation for unused services</li>
