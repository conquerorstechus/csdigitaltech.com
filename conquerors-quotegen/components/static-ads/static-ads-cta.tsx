...
export function StaticAdsCta() {
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-[#1E5AA8] to-[#154080]">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6">
          Ready to Launch High-Converting Ads?
        </h2>
        <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
          Schedule your free consultation and let's create ads that actually drive results.
        </p>
        ...
        <p className="text-sm text-blue-200 mt-6">
          No credit card required • Portfolio consultation included
        </p>
      </div>
    </section>
  )
