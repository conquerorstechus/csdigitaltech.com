...
const testimonials = [
  {
    id: 1,
    quote: "Cornerstone Digital Technologies has transformed our business operations with their innovative solutions. The team's expertise and dedication to quality is unmatched. Highly recommended for any technology needs.",
    name: "Sandy",
    title: "Tech Lead",
  ...
  {
    id: 3,
    quote: "The professionalism and attention to detail from the Cornerstone Digital Technologies team is exceptional. They delivered our project on time and exceeded all expectations. A true partner in success.",
    name: "Sai",
  ...
  {
    id: 4,
    quote: "Outstanding service and support from Cornerstone Digital Technologies. They understood our vision and brought it to life with precision. Would definitely work with them again.",
    name: "Michael",
  ...
  {
    id: 5,
    quote: "The team at Cornerstone Digital Technologies is highly skilled and professional. They provided solutions that were not just effective but also cost-efficient. Highly impressed with the results.",
  ...
  {
    id: 6,
    quote: "Cornerstone Digital Technologies' approach to problem-solving is refreshing. They took the time to understand our needs and delivered a solution that perfectly fit our requirements.",
  ...
  {
    id: 7,
    quote: "Working with the Cornerstone Digital Technologies team has been one of the best decisions for our company. Their commitment to excellence and innovation is truly commendable.",
    name: "Beauty",
