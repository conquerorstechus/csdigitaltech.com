...
const portfolioItems = [
  {
    ...
    introductionText:
      'Conquerors Technologies delivers custom B2B & B2C e-commerce solutions, designing user-friendly sites and enhancing apps to boost business growth for clients worldwide. Elevate your online presence today.',
    category: 'Best E-commerce Application',
    subcategory:
      'Conquerors Technologies: Experts in custom e-commerce solutions. We build tailored, user-friendly applications to help your business thrive globally, offering growth-oriented websites and unique feature enhancements.',
    ...
    subfeatures: [
      ...
      'Conquerors Technologies: Empowering businesses with customizable e-commerce solutions for seamless operations and enhanced customer experiences. Enhance online presence, user-friendly features.',
...
export async function generateMetadata({
  ...
  const metaTitle = metaTitles[slug] || `${item.title} - ${item.category} Development Project | Conquerors Technologies`
  ...
  if (customKeywords) {
    ...
    const baseKeywords = [
      ...
      'conquerors technologies portfolio',
...
export default async function PortfolioDetailPage({
  ...
  const structuredData = getStructuredData(
    `${item.title} - ${item.category} Development Project | Conquerors Technologies`,
