...
export const metadata = getComprehensiveMetadata(
  ...
  "Cornerstone Digital Technologies is a leading Custom Software Development Company in Florida delivering tailored, scalable, and secure digital solutions to accelerate your business growth.",
...
export default function CustomSoftwareDevelopment() {
  const structuredData = getStructuredData(
    "Custom Software Development Company in Florida | Cornerstone Digital Technologies Tech",
    "Cornerstone Digital Technologies is a leading custom software development company in Florida offering custom software solutions, enterprise software development, full stack development services, and digital cloud solutions. Expert software developers for your business needs.",
    "/custom-software-development-company-in-florida",
    "Service"
  );
