...
export const metadata = getComprehensiveMetadata(
  ...
  'Expert Software development company in Florida. Conquerors Technologies powers business growth with advanced web, mobile development, AI/IoT, cloud tech, and IT consulting based in Tampa.',
  '/',
