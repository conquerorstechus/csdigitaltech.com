...
export const metadata = getComprehensiveMetadata(
  ...
  'Discover expert branding agency services at Conquerors Technologies—offering brand strategy, identity design, and digital branding solutions to elevate your business presence and impact.',
