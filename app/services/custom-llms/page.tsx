...
export const metadata = getComprehensiveMetadata(
  ...
  'AI-driven custom LLM integration boosts Florida enterprises efficiency and customer engagement, powered by Cornerstone Digital Technologies expertise in intelligent automation and real-time insights',
