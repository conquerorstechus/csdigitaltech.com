...
export const metadata = getComprehensiveMetadata(
  ...
  'Get reliable Software Development Services in Florida with Conquerors Technologies, offering tailored, scalable, and high-performance solutions to drive your business growth.',
