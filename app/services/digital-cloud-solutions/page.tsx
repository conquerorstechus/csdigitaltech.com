...
export const metadata = getComprehensiveMetadata(
  ...
  'Power your business with Cornerstone Digital Technologies—Florida’s top choice for secure, scalable, and high-performance digital and cloud solutions that drive real transformation.',
