...
export const metadata = getComprehensiveMetadata(
  ...
  "Want flawless apps? Cornerstone Digital Technologies in Florida runs in-depth QA testing to catch bugs early, boost performance, and make sure your software runs exactly like you want.",
