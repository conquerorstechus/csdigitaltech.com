          ...
          <div className='max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center'>
            ...
            <div className="text-center md:text-left">
              ...
              <p className='text-gray-700 text-sm sm:text-lg leading-7 md:leading-8 tracking-wide text-justify md:text-left'>
                Conquerors Software Technologies USA delivers AI-driven data science and analytics solutions that empower organisations to predict trends, optimise decision-making, and uncover hidden insights within their data.
              </p>
