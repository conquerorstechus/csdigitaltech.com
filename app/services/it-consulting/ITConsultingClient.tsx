        ...
        <section className='relative py-16 px-4 bg-cover bg-center bg-no-repeat bg-[url("/ctabg.jpg")]'>
          ...
          <div className='relative z-10 max-w-4xl mx-auto text-center'>
            ...
            <p className='text-white text-lg leading-relaxed mb-8'>
              At Conquerors Software Technologies USA, we deliver AI-driven consulting that simplifies technology adoption, improves efficiency, and accelerates growth for businesses across Florida and beyond.
            </p>
