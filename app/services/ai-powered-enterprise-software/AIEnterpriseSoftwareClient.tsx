      ...
      <main className='bg-gray-50'>
        ...
        <section className='max-w-6xl mx-auto px-4 py-12'>
          <div className='text-gray-700 font-normal space-y-6 text-justify text-lg leading-8 tracking-wide'>
            <p>
              Cornerstone Digital Technologies USA builds intelligent, cross-platform enterprise applications that combine artificial intelligence with modern frameworks such as Flutter, React Native, and Progressive Web Apps (PWAs). Our solutions are designed to be scalable, adaptive, and user-centric, empowering businesses to automate workflows, personalize user experiences, and make smarter decisions in Florida and across other regions in the USA.
            </p>
            <p>
        ...
        <section className='bg-white py-16'>
          <div className='max-w-6xl mx-auto px-4'>
            <h2 className='text-3xl lg:text-4xl font-extrabold text-center text-gray-900 mb-12'>
              Why Cornerstone Digital Technologies USA?
            </h2>
        ...
        <section className='bg-gradient-to-r from-blue-600 to-blue-800 py-16'>
          <div className='max-w-4xl mx-auto px-4 text-center'>
            ...
            <p className='text-white text-lg mb-8 leading-relaxed'>
              Enterprise software should do more than support operations—it should drive business growth. With Cornerstone Digital Technologies, you gain a partner that builds future-ready, AI-powered solutions customized to your needs.
            </p>
