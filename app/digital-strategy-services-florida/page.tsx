...
export const metadata = getComprehensiveMetadata(
  ...
  "Achieve digital success with Conquerors Technologies in Florida. We design smart, customized digital strategies that strengthen brand visibility and deliver real business impact.",
...
export default function DigitalStrategyServices() {
  const structuredData = getStructuredData(
    "Digital Strategy Services in Florida | Conquerors Tech",
    "Conquerors Technologies is a leading digital strategy services company in Florida offering digital transformation consulting, digital business strategy, and digital innovation strategy. Get comprehensive digital strategy solutions for your business.",
    "/digital-strategy-services-florida",
    "Service"
  );
