...
export const metadata = getComprehensiveMetadata(
  ...
  "Conquerors Technologies is a leading Ionic application development company in Florida offering custom Ionic development, cross-platform mobile apps, and expert Ionic developers. Get high-quality Ionic apps built with web technologies.",
  "/ionic-application-development-company-in-florida",
...
export default function IonicApplicationDevelopment() {
  const structuredData = getStructuredData(
    "Ionic Application Development Company in Florida | Conquerors Tech",
    "Conquerors Technologies is a leading Ionic application development company in Florida offering custom Ionic development, cross-platform mobile apps, and expert Ionic developers. Get high-quality Ionic apps built with web technologies.",
    "/ionic-application-development-company-in-florida",
    "Service"
  );
