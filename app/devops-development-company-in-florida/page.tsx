...
export const metadata = getComprehensiveMetadata(
  ...
  "Get cutting-edge DevOps services in Florida with Conquerors Technologies: we streamline your delivery pipeline, automate infrastructure, and boost deployment speed.",
  "/devops-development-company-in-florida",
...
export default function DevOpsDevelopment() {
  const structuredData = getStructuredData(
    "DevOps Development Company in Florida | Conquerors Tech",
    "Get cutting-edge DevOps services in Florida with Conquerors Technologies: we streamline your delivery pipeline, automate infrastructure, and boost deployment speed.",
    "/devops-development-company-in-florida",
    "Service"
  );
