...
export const metadata = getComprehensiveMetadata(
  ...
  "Build powerful web apps with Laravel development services from Conquerors Technologies in Florida — clean code, high performance, and long-term scalability.",
  "/laravel-development-company-in-florida",
...
export default function LaravelDevelopment() {
  const structuredData = getStructuredData(
    "Laravel Development Company in Florida  | Conquerors Tech",
    "Build powerful web apps with Laravel development services from Conquerors Technologies in Florida — clean code, high performance, and long-term scalability.",
    "/laravel-development-company-in-florida",
    "Service"
  );
