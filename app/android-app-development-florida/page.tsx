...
export const metadata = getComprehensiveMetadata(
  ...
  "Conquerors Technologies is a leading Android app development company in Florida offering native Android application development, custom mobile app solutions, and expert Android developers. Get high-performance Android apps built with latest technologies.",
...
export default function AndroidAppDevelopment() {
  const structuredData = getStructuredData(
    "Android App Development Company in Florida | Conquerors Tech",
    "Conquerors Technologies is a leading Android app development company in Florida offering native Android application development, custom mobile app solutions, and expert Android developers. Get high-performance Android apps built with latest technologies.",
    "/android-app-development-florida",
    "Service"
  );
