...
export const metadata = getComprehensiveMetadata(
  ...
  "Looking for Drupal web development in Florida? Conquerors Technologies delivers custom, secure, and scalable Drupal sites tailored to your goals.",
  "/drupal-development-company-in-florida",
...
export default function DrupalDevelopment() {
  const structuredData = getStructuredData(
    ...
    "Conquerors Technologies is a leading Drupal development company in Florida offering custom Drupal website development, module development, theme customization, and Drupal maintenance services. Expert Drupal developers for enterprise solutions.",
    "/drupal-development-company-in-Florida",
    "Service"
  );
