...
export const metadata = getComprehensiveMetadata(
  ...
  "Get advanced data science solutions in Florida with Cornerstone Digital Technologies. We turn your data into actionable insights, predictive models, and business growth.",
...
export default function DataScienceServices() {
  const structuredData = getStructuredData(
    "Data Science services in Florida | Cornerstone Digital Technologies Tech",
    "Get advanced data science solutions in Florida with Cornerstone Digital Technologies. We turn your data into actionable insights, predictive models, and business growth.",
    "/data-science-services-florida",
    "Service"
  );
