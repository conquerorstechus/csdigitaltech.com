...
export const metadata = getComprehensiveMetadata(
  ...
  "Enhance efficiency with AI-enabled infrastructure and support services from Cornerstone Digital Technologies, a trusted Florida company delivering smart, automated IT operations.",
...
export default function AIEnabledInfrastructureSupportServices() {
  const structuredData = getStructuredData(
    "AI-Enabled Infrastructure & Support Services Company in Florida | Cornerstone Digital Technologies Tech",
    "Cornerstone Digital Technologies is a leading AI-enabled infrastructure and support services company in Florida offering AI-powered IT infrastructure management, intelligent monitoring, predictive maintenance, automated optimization, and proactive support services. Expert AI infrastructure solutions.",
    "/ai-enabled-infrastructure-support-services",
    "Service"
  );
