...
export const metadata = getComprehensiveMetadata(
  ...
  "Empower data-driven decisions with Cornerstone Digital Technologies, a top Business Intelligence Company in Florida delivering smart BI solutions for improved insights and performance.",
...
export default function BusinessIntelligenceDevelopment() {
  const structuredData = getStructuredData(
    "Business Intelligence Development Company in Florida | Cornerstone Digital Technologies Tech",
    "Cornerstone Digital Technologies is a leading business intelligence development company in Florida offering BI services, data analytics, dashboards, reporting, and enterprise BI solutions. Get expert business intelligence consulting and development services.",
    "/business-intelligence-development-company-in-florida",
    "Service"
  );
